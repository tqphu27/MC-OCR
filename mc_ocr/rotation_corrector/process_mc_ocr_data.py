...
output_txt_dir = '/datausers/ioit/dungduc.student/MC_OCR/mc_ocr/data/temp_out/txt'
output_viz_dir = '/datausers/ioit/dungduc.student/MC_OCR/mc_ocr/data/temp_out/viz_imgs'
output_rotated_img_dir = '/datausers/ioit/dungduc.student/MC_OCR/mc_ocr/data/temp_out/imgs'
...
def main():
    ...
    if img_path != '':
        ...
        list_img_path = os.listdir(img_dir)
