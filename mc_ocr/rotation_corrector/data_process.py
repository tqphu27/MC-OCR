...
def crop_fr_detector_filterd_20210121(remake=False):
    base_output_dir = '/datausers/ioit/dungduc.student/MC_OCR/mc_ocr/data/temp-o/line_cropped'
    if remake:
        if os.path.exists(base_output_dir):
            shutil.rmtree(base_output_dir)
    data_in = [
        {
            'img_dirs': '/datausers/ioit/dungduc.student/MC_OCR/mc_ocr/data/temp-o/imgs',
            'lbl_dirs': '/datausers/ioit/dungduc.student/MC_OCR/mc_ocr/data/temp-o/txt',
