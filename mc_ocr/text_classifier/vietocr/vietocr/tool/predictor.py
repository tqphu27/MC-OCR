...
class Predictor():
    def __init__(self, config):
        ...
        model.load_state_dict(torch.load("/datausers/ioit/dungduc.student/MC_OCR/mc_ocr/text_classifier/vietocr/config/transformerocr.pth", map_location=torch.device(device)))
