...
OUTPUT_ROOT = '/datausers/ioit/dungduc.student/MC_OCR/mc_ocr/test03'
...
# text detector
det_model_dir = full_path('/datausers/ioit/dungduc.student/MC_OCR/mc_ocr/data/ch_ppocr_server_v2.0_det_infer/')
det_visualize = True
det_db_thresh = 0.3
...
rot_drop_thresh = [.5, 2]
rot_visualize = True
rot_model_path = full_path('/datausers/ioit/dungduc.student/MC_OCR/mc_ocr/rotation_corrector/weights/mobilenetv3-Epoch-487-Loss-0.03-Acc-0.99.pth', file=True)
...
cls_visualize = True
cls_ocr_thres = 0.65
cls_model_path = full_path('/datausers/ioit/dungduc.student/MC_OCR/mc_ocr/text_classifier/vietocr/config/transformerocr.pth', file=True)
...
# key information
kie_visualize = True
kie_model = full_path('/datausers/ioit/dungduc.student/MC_OCR/mc_ocr/key_info_extraction/PICK/model_best.pth', file=True)
